...
from envs import SimpleEnv, EvolvingEnv
...
class Runner:
    def __init__(self, env_class=EvolvingEnv, model_class=SimpleModel.build_model, agent_class=SimpleAgent,
...
if __name__ == '__main__':
    r = Runner(env_class=EvolvingEnv, test_set=22, real=False)
    r.run()
    exit()
