...
import time
from EVR.multi_sort.commons import _get_scenarios_and_executors, get_current_makespan, print_results, get_max_time_id
...
class Runner:
    ...
    def min_time_and_executor_overall(scenario, executors) -> Tuple[Scenario, EvrExecutor, float]:
        ...
        for executor in executors:
            ...
            if cur_time == executor.get_max_time():
    ...
    def run(test_set=1, real=False):
        ...
        best_fit = get_max_time_id(groups)
